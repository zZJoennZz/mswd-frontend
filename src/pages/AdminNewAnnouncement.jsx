                ...
                <Col md={12}>
                    <Form onSubmit={onSubmitUpdated}>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" name="announcement_title" id="announcement_title" onChange={onChangeUpdatedText} />
                        </Form.Group>
                        <Form.Group className="mb-3">
                            <Form.Label>Announcement Body</Form.Label>
                            <SunEditor height="500" name="announcement_body" id="announcement_body" onChange={sunEditorOnChange} />
                        </Form.Group>
                        <Form.Group className="mb-3">
