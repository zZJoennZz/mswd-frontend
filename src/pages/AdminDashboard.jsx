...
const AdminDashboard = ({ dashCtr }) => {
  ...
  return (
    <Container fluid>
      ...
      <Row>
        <Col md="12">
          <h1 onClick={getCurrTime} className="h2">
            Dashboard
          </h1>
          ...
          >
            ...
            <Card.Body>
              <Card.Title>
                {dashCtr === "Loading..."
                  ? dashCtr
                  : kFormatter(dashCtr.inq_count)}
              </Card.Title>
              <Card.Text>Total # of Inquiries</Card.Text>
            </Card.Body>
          </Card>
        </Col>
        <Col md={6} lg={3}>
          ...
          >
            ...
            <Card.Body>
              <Card.Title>
                {dashCtr === "Loading..."
                  ? dashCtr
                  : kFormatter(dashCtr.app_count)}
              </Card.Title>
              <Card.Text>Total # of Applications</Card.Text>
            </Card.Body>
          </Card>
        </Col>
        <Col md={6} lg={3}>
          <Card className="mb-3" border="info" style={{ minHeight: "160px" }}>
            ...
            <Card.Body>
              <Card.Title>
                {dashCtr === "Loading..."
                  ? dashCtr
                  : kFormatter(dashCtr.app_proce_count)}
              </Card.Title>
              <Card.Text>Total # of Processing Applications</Card.Text>
            </Card.Body>
          </Card>
        </Col>
        <Col>
