...
const EServices = () => {
    ...
    let [formMode, setFormMode] = React.useState(3);
    ...
    const registerUser = async (e) => {
        ...
        try {
            await axios.post(`${process.env.REACT_APP_API}register`, frmData, {headers})
                .then(res => {
            ...
            <Container>
                            ...
                            <Col lg={10}>
                                <Card className="p-3 mb-5 text-start">
                                    <Card className="mb-3" border="primary">
                                        <Card.Header><h2 className="text-uppercase">Application for Identification Card of Solo Parent</h2></Card.Header>
                                        ...
                                        <Card.Body className="p-3 mb-3">
                                            <Accordion>
                                                ...
                                                <Accordion.Item eventKey="1">
                                                    ...
                                                    <Accordion.Body>
                                                        <p><strong>Step 1: </strong>Applicant must register by clicking the “Don't have an account? Register here!” tab, follow the instructions. <em>(Magrehistro muna sa pamamagitan ng pag pindot ng “Don't have an account? Register here!” tab, sundin ang mga kailangan.)</em></p>
                                                        <p><strong>Step 2: </strong>If applicant has successfully registered, login and go to Solo Parent I.D. application form. <em>(Kapag nakapag registro na ang aplikante, mag-login muna at pumunta sa Solo Parents I.D. Application Form.)</em></p>
                                                        <p><strong>Step 3: </strong>Review the documents required before proceeding. <em>(Suriing mabuti ang mga dokumentong kinakailangan bago magpatuloy.)</em></p>
                                                        <p><strong>Step 4: </strong>Fill up all required fields in the Solo Parent I.D. application form. <em>(Sagutan ang lahat ng kailangan sa Solo Parent I.D.  application form.)</em></p>
                                                        <p><strong>Step 5: </strong>Upload scanned copies of required documents. <em>(Mag-upload ng mga na-scan na kopya ng mga kinakailangang dokumento.)</em></p>
                                                        <p><strong>Step 6: </strong>Check submitted application. <em>(Suriin ang pinunang aplikasyon.)</em></p>
                                                        <p><strong>Step 7: </strong>Applicant will receive notification of the successful application of Solo Parent I.D. via email. <em>(Makakatanggap ng email ang aplikante na matagumpay na aplikayson para sa Solo Parent I.D.)</em></p>
                                                        <p><strong>Step 8: </strong>MSWD Staff will assess the submitted online application. <em>(Susuriin ng MSWD Staff ang naisumiteng aplikasyon.)</em></p>
                                                        <p><strong>Step 9: </strong>Applicant will be able to track their transaction by clicking the “Track my application” tab in their dashboard. <em>(Magagawang subaybayan ng aplikante ang kanilang transaksyon sa pamamagitan ng pag-click sa tab na "Track my application" sa kanilang dashboard.)</em></p>
                                                        <p><strong>Step 10: </strong>Applicant will receive notification if his/her Solo Parent I.D. are ready to release. <em>(Makakatanggap ang aplikante ng abiso kung ang kanyang Solo Parent I.D. ay handa at maari ng kuhain.)</em></p>
                                                        <p><strong>Step 11: </strong>Applicant will proceed to MSWD office in San Rafael Bulacan to claim his/her Solo Parent I.D after they receive notification. <em>(Magpunta sa MSWD Office of San Rafael Bulacan para kunin ang Solo Parent I.D. pagkatapos matanggap ang abiso.)</em></p>
                                    ...
                                    <Card className="mb-3" border="primary">
                                        <Card.Header><h2 className="text-uppercase">Application for Identification Card of Senior Citizen</h2></Card.Header>
                                        ...
                                        <Card.Body className="p-3 mb-3">
                                            <Accordion>
                                                ...
                                                <Accordion.Item eventKey="1">
                                                    ...
                                                    <Accordion.Body>
                                                        <p><strong>Step 1: </strong>Applicant must register by clicking the “Don't have an account? Register here!” tab, follow the instructions. <em>(Magrehistro muna sa pamamagitan ng pag pindot ng “Don't have an account? Register here!” tab, sundin ang mga kailangan.)</em></p>
                                                        <p><strong>Step 2: </strong>If applicant has successfully registered, login and go to Senior Citizen I.D. application form. <em>(Kapag nakapag registro na ang aplikante, mag-login muna at pumunta sa Senior Citizen I.D. Application Form.)</em></p>
                                                        <p><strong>Step 3: </strong>Review the documents required before proceeding. <em>(Suriing mabuti ang mga dokumentong kinakailangan bago magpatuloy.)</em></p>
                                                        <p><strong>Step 4: </strong>Fill up all required fields in the Senior Citizen I.D. application form. <em>(Sagutan ang lahat ng kailangan sa Senior Citizen I.D.  application form.)</em></p>
                                                        <p><strong>Step 5: </strong>Upload scanned copies of required documents. <em>(Mag-upload ng mga na-scan na kopya ng mga kinakailangang dokumento.)</em></p>
                                                        <p><strong>Step 6: </strong>Check submitted application. <em>(Suriin ang pinunang aplikasyon.)</em></p>
                                                        <p><strong>Step 7: </strong>Applicant will receive notification of the successful application of Senior Citizen I.D. via email. <em>(Makakatanggap ng email ang aplikante na matagumpay na aplikayson para sa Senior Citizen I.D.)</em></p>
                                                        <p><strong>Step 8: </strong>MSWD Staff will assess the submitted online application. <em>(Susuriin ng MSWD Staff ang naisumiteng aplikasyon.)</em></p>
                                                        <p><strong>Step 9: </strong>Applicant will be able to track their transaction by clicking the “Track my application” tab in their dashboard. <em>(Magagawang subaybayan ng aplikante ang kanilang transaksyon sa pamamagitan ng pag-click sa tab na "Track my application" sa kanilang dashboard.)</em></p>
                                                        <p><strong>Step 10: </strong>Applicant will receive notification if his/her Senior Citizen I.D. are ready to release. <em>(Makakatanggap ang aplikante ng abiso kung ang kanyang Senior Citizen I.D. ay handa at maari ng kuhain.)</em></p>
                                                        <p><strong>Step 11: </strong>Applicant will proceed to MSWD office in San Rafael Bulacan to claim his/her Senior Citizen I.D. after they receive notification. <em>(Magpunta sa MSWD Office of San Rafael Bulacan para kunin ang Senior Citizen I.D. pagkatapos matanggap ang abiso.)</em></p>
                                                        <p className="text-center" style={{ textTransform: 'uppercase' }}>*** End of transaction ***</p>
                                                    </Accordion.Body>
                                                </Accordion.Item>
                                                <Accordion.Item eventKey="2">
                                    ...
                                    <Card border="primary">
                                        <Card.Header><h2 className="text-uppercase">Application for Identification Card of Persons with Disability</h2></Card.Header>
                                            ...
                                            <Accordion>
                                                ...
                                                <Accordion.Item eventKey="1">
                                                    ...
                                                    <Accordion.Body>
                                                        ...
                                                        <p><strong>Step 2: </strong>If applicant has successfully registered, login and go to Person with Disabilities I.D. application form. <em>(Kapag nakapag registro na ang aplikante, mag-login muna at pumunta sa Person with Disabilities I.D. Application Form.)</em></p>

                                                        <p><strong>Step 3: </strong>Review the documents required before proceeding. <em>(Suriing mabuti ang mga dokumentong kinakailangan bago magpatuloy.)</em></p>

                                                        <p><strong>Step 4: </strong>Fill up all required fields in the Person with Disabilities I.D. application form. <em>(Sagutan ang lahat ng kailangan sa Person with Disabilities I.D. application form.)</em></p>

                                                        <p><strong>Step 5: </strong>Upload scanned copies of required documents. <em>(Mag-upload ng mga na-scan na kopya ng mga kinakailangang dokumento.)</em></p>

                                                        <p><strong>Step 6: </strong>Check submitted application. <em>(Suriin ang pinunang aplikasyon.)</em></p>

                                                        <p><strong>Step 7: </strong>Applicant will receive notification of the successful application Person with Disabilities I.D. via email. <em>(Makakatanggap ng email ang aplikante na matagumpay na aplikayson para sa Person with Disabilities I.D.)</em></p>

                                                        <p><strong>Step 8: </strong>MSWD Staff will assess the submitted online application. <em>(Susuriin ng MSWD Staff ang naisumiteng aplikasyon.)</em></p>

                                                        <p><strong>Step 9: </strong>Applicant will be able to track their transaction by clicking the “Track my application” tab in their dashboard. <em>(Magagawang subaybayan ng aplikante ang kanilang transaksyon sa pamamagitan ng pag-click sa tab na "Track my application" sa kanilang dashboard.)</em></p>

                                                        <p><strong>Step 10: </strong>Applicant will receive notification if his/her Person with Disabilities I.D. are ready to release. <em>(Makakatanggap ang aplikante ng abiso kung ang kanyang Person with Disabilities I.D. ay handa at maari ng kuhain.)</em></p>

                                                        <p><strong>Step 11: </strong>Applicant will proceed to MSWD office in San Rafael Bulacan to claim his/ Person with Disabilities I.D.  after they receive notification. <em>(Magpunta sa MSWD Office of San Rafael Bulacan para kunin ang Person with Disabilities I.D. pagkatapos matanggap ang abiso.)</em></p>
                                                        <p className="text-center" style={{ textTransform: 'uppercase' }}>*** End of transaction ***</p>
                                                    </Accordion.Body>
                                                </Accordion.Item>
                                                <Accordion.Item eventKey="2">
                                    ...
                                    <Row className="mt-3 text-center">
                                        <Col lg={6}><Button variant="primary" onClick={(e) => setFormMode(1)}>Don't have an account? Register here!</Button></Col>
                                        <Col lg={6}><Button variant="success" onClick={(e) => setFormMode(0)}>Already have an account? Log in here!</Button></Col>
                                    </Row>
                                </Card>
                            </Col>
                            <Col lg={1}></Col>
                        ...
                        <>
                            ...
                            <Col className="text-start" lg={4}>
                                <Card className="p-3 mb-5">
                                    <img src={mswdoImg} className="mb-3" width="100%" alt="MSWDO Logo" />
                                    {
                                        message !== "" ?
                                        ...
                                        :
                                            <div>
                                                ...
                                                <Form onSubmit={registerUser} className="mb-3">
                                                    <Form.Group className="mb-3">
                                                        <Form.Label>First Name</Form.Label><div className="float-end fst-italic">(Pangalan)</div>
                                                        <Form.Control value={frmData.name} id="name" name="name" type="text" placeholder="Enter first name" onChange={onChangeText} />
                                                    </Form.Group>

                                                    <Form.Group className="mb-3">
                                                        <Form.Label>Last Name</Form.Label><div className="float-end fst-italic">(Apelyido)</div>
                                                        <Form.Control value={frmData.last_name} id="last_name" name="last_name" type="text" placeholder="Enter last name" onChange={onChangeText} />
                                                    </Form.Group>
                                                    
                                                    <Form.Group className="mb-3">
                                                        <Form.Label>Email address</Form.Label><div className="float-end fst-italic">(Valid Email Only)</div>
                                                    ...
                                                    <Form.Group className="mb-3">
                                                        <Row>
                                                            <Col sm={1}>
                                                                <Form.Check type="checkbox" onChange={(e) => setAgreeCheck(!agreeCheck)} />
                                                            </Col>
                                                            <Col sm={11}>
                                                                <Form.Label onClick={handleOpen} style={{ color: 'blue', cursor: 'pointer', textDecoration: 'underline' }}>I accept the Terms and Conditions</Form.Label>
                                                            </Col>
                                                        </Row>
                                                    </Form.Group>
                                                    <Button variant="primary" type="submit" disabled={!agreeCheck}>
                                                        Register
                                                    </Button>
                                                </Form>
                ...
                <Modal size="lg" show={show} onHide={handleClose}>
                    ...
                    <Modal.Body>
                        ...
                        <p>This privacy notice discloses the privacy practices for MSWDO San Rafael, Bulacan Website. This privacy notice applies solely to information collected by this website.</p>
                        <h4>Registration</h4>
                        <p>In order to use this website, a user must first complete the registration form. During registration a user is required to give certain information (such as name and email address). This information is used to contact you about the service status and account matters on our site in which you have expressed interest. By signing up you agree to:</p>
                        <ol>
                            <li>Provide true and complete information as prompted by the eServices' forms;</li>
                            <li>Not to disclose or sharing your password to any third parties;</li>
                            <li>You are responsible for maintaining the confidentiality of the password and account, and are fully responsible for all activities that occur under your password or account;</li>
                        </ol>
                        <h4>Coverage of Service</h4>
                        <p>The MSWDO San Rafael, Bulacan eServices covers the online and mobile applications, processing and approvals of the following frontline services: Travel Clearance for Minors Travelling Abroad (MTA) and Registration, Licensing and Accreditation (RLA) of Social Welfare and Development Agencies and Service Providers.</p>
                        <h4>Information Collection, Use, and Sharing</h4>
                        <p>We are the sole owners of the information collected on this site. We only have access to/collect information that you voluntarily give us via the modules of this website or other direct contact from you. We will not sell or rent this information to anyone. All of the provisions in the Data Privacy Act will be observed specifically on the management of personal identifiable information.</p>
                        <p>We will use your information to respond to you, regarding the services that you require. We will not share your information with any third party outside of our organization, other than as necessary to fulfill your requested services. The DSWD however reserves the right to request the applicants to submit the hardcopy of documentary requirements in order to verify the authenticity of the information;</p>
                        <p>Unless you ask us not to, we may contact you via email or SMS in the future to tell you about the status of your transaction/service request or changes to this privacy policy.</p>
                        <h4>Security</h4>
                        <p>We take precautions to protect your information. When you submit sensitive information via the website, your information is protected both online and offline. Wherever we collect sensitive information (such as passport and Birth Certificates), that information is encrypted and transmitted to us in a secure way. You can verify this by looking for a lock icon in the address bar and looking for "https" at the beginning of the address of the Web page.</p>
                        <p>While we use encryption to protect sensitive information transmitted online, we also protect your information offline. Only employees who need the information to perform a specific job (for example, certificate printing or customer service) are granted access to personally identifiable information. The computers/servers in which we store personally identifiable information are kept in a secure environment.</p>
                        <p><strong>If you feel that we are not abiding by this privacy policy, you should contact us immediately via mobile phone at (+63) 922-564-5695 or via mswdosanrafaelbulacan@gmail.com.</strong></p>
                        <p><strong><em>DSWD Reserves the right to remove accounts that are deemed intrusive to the e-Services application</em></strong></p>
                        <h4>"I HEREBY AGREE TO BE GOVERNED BY THE TERMS AND CONDITIONS OF THE DSWD ESERVICES PRIVACY NOTICE AND USER AGREEMENT. I HEREBY ALSO ACKNOWLEDGE TO HAVE READ AND FULLY UNDERSTOOD THE SAID TERMS AND CONDITIONS."</h4>
                    </Modal.Body>
                    <Modal.Footer>
                                ...
                                <div className="p-3">
                                    <Form onSubmit={saveProfile}>
                                        ...
                                        <Form.Group className="mb-3">
                                            ...
                                            <Form.Control defaultValue={currentLastName} id="last_name" name="last_name" type="text" placeholder="Full name" onChange={onChangeText} />
                                        </Form.Group>
