      ...
      <ul className="nav flex-column">
        ...
        <li className="nav-item navbar-text">
          <a className="nav-link" href="/admin/inquiries">
            ...
            &nbsp;<span className="ms-2">Inquiries</span>
          </a>
        </li>
        <li className="nav-item navbar-text">
          <a className="nav-link" href="/admin/faqs">
            ...
            >
              ...
              <g>
                ...
                <g>
                  {" "}
                  <path d="M153.385,286.464c-0.003,0-0.007,0-0.011,0c-4.427,0-8.022,3.595-8.022,8.022c0,0.001,0,0.003,0,0.005 c0,0.002,0,0.003,0,0.005c0,4.427,3.595,8.022,8.022,8.022c0.003,0,0.008,0,0.011,0c4.427,0,8.022-3.595,8.022-8.022 c0-0.001,0-0.003,0-0.005c0-0.002,0-0.003,0-0.005C161.407,290.059,157.812,286.464,153.385,286.464z" />{" "}
                </g>{" "}
              </g>{" "}
              <g>
                {" "}
        ...
        <li className="nav-item navbar-text">
          <a className="nav-link" href="/admin/organization">
            ...
            &nbsp;<span className="ms-2">Organization</span>
          </a>
        </li>
        <li className="nav-item navbar-text">
          <a className="nav-link" href="/admin/reports">
            <svg
              ...
              style={{ enableBackground: "new 0 0 103.12 122.88" }}
            >
              <g>
                <path
